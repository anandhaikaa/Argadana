...
<div class="wrap">
  <header>
    <div class="container">
      <h1><a href="#">Argadana Petshop</a></h1>
      ...
      <form action="" id="search-form" method="post">
        <fieldset>
          <div class="rowElem">
              ...
              <input type="text" name="input_cari" placeholder="Cari Berdasar Nama Barang atau Layanan" class="css-input" style="width:250px;" />
    ...
    <aside>
      <h3>Kategori</h3>
        ...
        <?php
          ...
          {
          ?><h3>Silakan Login untuk Detailnya</h3>
            ...
            <fieldset>
              <div class="rowElem">
                ...
                <input type="password" name="password" placeholder="Enter Your Password Here" onFocus="if(this.value=='Enter Your Email Here'){this.value=''}" onBlur="if(this.value==''){this.value='Enter Your Email Here'}" >
                  ...
                  <div class="clear"><a href="index.php?p=sign-up" class="fleft" style="text-decoration: underline;">Sign Up For Free</a>
                  <button type="submit" class="btn btn-xs btn-default fright">Log In</button></div>
              </div>
            </fieldset>
...
<footer>
  <div class="footerlink">
    <p class="lf">Copyright &copy; 2020 <a href="#">Argadana Petshop</a> - All Rights Reserved
    </p>
