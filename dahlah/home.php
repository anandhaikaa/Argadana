<section id="content">
  <div class="inside">
    <h2>Recent Products and Services</h2>
    <ul class="list" style="border-color:#000; text-align:center">

      <?php
      $input_cari = @$_POST['input_cari'];
      $cari = @$_POST['cari'];
      $sqldetail = "SELECT * FROM macam_kategori";
      ...
      /*while ($data = $querydetail->fetch_array()) {
        ...
        $sql = $mysqli->query("select * from macam_kategori where nama_barang_atau_layanan like '%$input_cari%'") or die (mysqli_error());
        } else {
       ...
       if($cek < 1) {
        ...
        <?php
         ...
         while ($databook = $sql->fetch_array()) {
           ?>
           <li><span><img style="width:50%;height:90px" src="foto_produk/<?php echo $databook['gambar']; ?>"></span>
             <h4><a href="#" title="Klik Untuk Reservasi" style="text-transform:uppercase"><?php echo $databook['nama_barang_atau_layanan']; ?></a></h4>
